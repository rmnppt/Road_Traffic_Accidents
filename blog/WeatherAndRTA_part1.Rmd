...
The object called `weather` is a `data.frame` in which we will store our results. Now all we need to do is loop through this object, each time collecting a result with our wrapper for `get_forecast_for`.
